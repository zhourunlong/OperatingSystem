...
int read_block(void* buf, int block_addr) {
    int file_offset = BLOCK_SIZE + block_addr * BLOCK_SIZE;
...
int read_segment_imap(void* buf, int segment_addr) {
    int file_offset = BLOCK_SIZE + segment_addr * SEGMENT_SIZE + IMAP_OFFSET;
...
int read_segment_summary(void* buf, int segment_addr) {
    int file_offset = BLOCK_SIZE + segment_addr * SEGMENT_SIZE + SUMMARY_OFFSET;
...
int write_segment(void* buf, int segment_addr) {
    int file_offset = BLOCK_SIZE + segment_addr * SEGMENT_SIZE;
